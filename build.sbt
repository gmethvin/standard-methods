...
scmInfo in ThisBuild := Some(
  ScmInfo(
    url("https://github.com/gmethvin/standard-methods"),
    "scm:git@github.com:gmethvin/standard-methods.git"
  )
)
...
crossScalaVersions in ThisBuild := Seq("2.11.12", scalaVersion.value, "2.13.0-M2")
